...
<body class="host_version"> 
	...
	<div class="all-title-box">
		<div class="container text-center">
			<h1>Maestros<span class="m_1">Lorem Ipsum dolroin gravida nibh vel velit.</span></h1>
		</div>
	</div>
            ...
            <div class="row">
				<div class="col-lg-3 col-md-6 col-12">
					<div class="our-team">
						...
						<div class="team-content">
							<h3 class="title">Gabriella Montez</h3>
				...
				<div class="col-lg-3 col-md-6 col-12">
					<div class="our-team">
						...
						<div class="team-content">
							<h3 class="title">Sharpay Evans</h3>
				...
				<div class="col-lg-3 col-md-6 col-12">
					<div class="our-team">
						...
						<div class="team-content">
							<h3 class="title">Taylor McKessie</h3>
							<span class="post">Web Developer</span>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-3 col-md-6 col-12">
					<div class="our-team">
						...
						<div class="team-content">
							<h3 class="title">Kelsi Nielsen</h3>
							<span class="post">Web Designer</span>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-3 col-md-6 col-12">
					<div class="our-team">
						...
						<div class="team-content">
							<h3 class="title">Monique Coleman </h3>
							<span class="post">Web Developer</span>
						</div>
					</div>
				</div>
                ...
                <div class="col-md-12 col-sm-12">
                    <div class="testi-carousel owl-carousel owl-theme">
                        <div class="testimonial clearfix">
                            ...
                            <div class="desc">
                                <h3><i class="fa fa-quote-left"></i> Director</h3>
                        ...
                        <div class="testimonial clearfix">
                            ...
                            <div class="desc">
                                <h3><i class="fa fa-quote-left"></i> Sub Director</h3>
                        ...
                        <div class="testimonial clearfix">
                            ...
                            <div class="desc">
                                <h3><i class="fa fa-quote-left"></i> Consejera</h3>
                        ...
                        <div class="testimonial clearfix">
                            ...
                            <div class="desc">
                                <h3><i class="fa fa-quote-left"></i> Guardia</h3>
                                <p class="lead">They have got my project on time with the competition with a sed highly skilled, and experienced & professional team.</p>
                            </div>
                            <!-- end testi-meta -->
                        </div>
                        ...
                        <div class="testimonial clearfix">
                            ...
                            <div class="desc">
                                <h3><i class="fa fa-quote-left"></i> Tesorero</h3>
                                <p class="lead">Explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I will give you completed.</p>
                            </div>
                            <!-- end testi-meta -->
                        </div>
                        ...
                        <div class="testimonial clearfix">
                            ...
                            <div class="desc">
                                <h3><i class="fa fa-quote-left"></i>Secretaria</h3>
                                <p class="lead">The master-builder of human happines no one rejects, dislikes avoids pleasure itself, because it is very pursue pleasure. </p>
                            </div>
                            <!-- end testi-meta -->
                        </div><!-- end testimonial -->
        ...
        <div class="container">
            <div class="footer-distributed">
                <div class="footer-center">                   
                    <p class="footer-company-name">All Rights Reserved. &copy; 2022 <a href="#">school Musical</a> Design By : <a>Grupo4</a></p>
                </div>
            </div>
        </div><!-- end container -->
    </div><!-- end copyrights -->
