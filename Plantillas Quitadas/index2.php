...
<html lang="es">
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
     ...
     <!-- Site Metas -->
    <title>School Musical - Education Responsive HTML5 Template</title>  
...
<body class="host_version"> 
		...
		<div class="modal-content">
			...
			<div class="modal-body customer-box">
				...
				<ul class="nav nav-tabs">
					<li><a class="active" href="#Login" data-toggle="tab">INICIO DE SESION</a></li>
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbars-host">
					...
					<ul class="nav navbar-nav navbar-right">
                        <li><a class="hover-btn-new log orange" href="#" data-toggle="modal" data-target="#login"><span>INICIA SESION</span></a></li>
                    </ul>
				</div>
			</div>
		</nav>
	...
	<div id="carouselExampleControls" class="carousel slide bs-slider box-slider" data-ride="carousel" data-pause="hover" data-interval="false" >
		...
		<div class="carousel-inner" role="listbox">
			<div class="carousel-item active">
				<div id="home" class="first-section" style="background-image:url('./src/images/slider-01.jpg');">
					<div class="dtab">
						<div class="container">
							<div class="row">
								<div class="col-md-12 col-sm-12 text-right">
									<div class="big-tagline">
										<h2><strong>School Musical </strong> Escuela Educativa</h2>
										<p class="lead">With Landigoo responsive landing page template, you can promote your all hosting, domain and email services. </p>
											<a href="#" class="hover-btn-new"><span>Contactenos</span></a>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<div class="carousel-item">
				<div id="home" class="first-section" style="background-image:url('./src/images/slider-02.jpg');">
					<div class="dtab">
						<div class="container">
							<div class="row">
			...
			<div class="carousel-item">
				<div id="home" class="first-section" style="background-image:url('./src/images/slider-03.jpg');">
					<div class="dtab">
						<div class="container">
							<div class="row">
        ...
        <div class="container">
            <div class="footer-distributed">
                <div class="footer-center">                   
                    <p class="footer-company-name">All Rights Reserved. &copy; 2022 <a href="#">School Musical</a> Design By : <a>Grupo 4</a></p>
                </div>
            </div>
        </div><!-- end container -->
    </div><!-- end copyrights -->
	...
	<script src="./src/js/timeline.min.js"></script>
	<script>
